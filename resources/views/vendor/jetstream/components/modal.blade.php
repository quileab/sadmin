...
<div
    ...
    style="display: none;"
>
    <div style="backdrop-filter: blur(1.5px);" x-show="show" class="fixed inset-0 transform transition-all" x-on:click="show = false" x-transition:enter="ease-out duration-300"
