<div>
    ...
    <div class="bg-white rounded-md shadow-md overflow-hidden max-w-4xl mx-auto mb-2 mt-4">
        ...
        <div class="p-4">
            ...
            <div class="flex flex-row flex-wrap">
                ...
                <div class="mx-2">
                    ...
                    <textarea wire:model="text" name="text" id="text" cols="30" rows="5"
        ...
        @if ($formAction == 'store')
            <div class="w-full d2c px-4 py-2">
                <button wire:click="store"
                    class="bg-green-500 hover:bg-green-700 text-white font-bold px-4 py-2 rounded text-xs">Crear</button>
            </div>
        @else
            <div class="w-full d2c px-4 py-2">
                <button wire:click="update"
                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded text-xs">Actualizar</button>
                <button wire:click="default"
                    class="bg-yellow-400 hover:bg-yellow-500 text-white font-bold px-4 py-2 rounded text-xs">Cancelar</button>
            </div>
        @endif
                ...
                @foreach ($infocards as $infocard)
                    ...
                    <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
                        ...
                        <article class="overflow-hidden rounded-lg shadow-lg">
                            ...
                            <header class="items-center text-right px-2 border-b md:px-4 bg-gray-100">
