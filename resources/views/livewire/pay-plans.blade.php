<div wire:init="loadData">
  ...
  <div class="flex flex-wrap">
    <button wire:click="openCreateMasterForm"
      class="flex items-center p-2 mx-1 my-1 content-center rounded shadow-lg bg-gray-800 text-gray-50">
    ...
    @foreach ($PlansMasters as $plan)
      ...
      <div class="md:w-52 sm:w-full rounded overflow-hidden shadow-lg bg-{{ $color }} text-white m-1">
        <div class="p-2 h-14">
          <small>Plan {{ $plan->id }}</small><br />{{ $plan->title }}
        </div>
        <div class="w-52 flex">
  ...
  <div class="flex flex-wrap">
    <button wire:click="openCreateDetailForm"
      class="flex items-center p-2 mx-1 my-1 content-center rounded shadow bg-blue-800 text-gray-50">
    ...
    @foreach ($PlansDetail as $detail)
      <div class="md:w-52 sm:w-full rounded overflow-hidden shadow-lg bg-blue-300 m-1">
