<div wire:init="loadData" class="p-2">
  ...
  <div class="flex flex-wrap rounded-md w-full shadow-lg p-2 mb-2 bg-stone-600">
    <button wire:click="openCreateMasterForm"
      class="flex items-center p-2 mx-1 my-1 content-center rounded shadow-lg bg-blue-800 hover:bg-blue-700 text-gray-50">
  ...
  <div class="flex flex-wrap w-full p-2">
    <button wire:click="openCreateDetailForm"
      class="flex items-center p-2 mx-1 my-1 content-center rounded shadow bg-blue-800 hover:bg-blue-700 text-gray-50">
